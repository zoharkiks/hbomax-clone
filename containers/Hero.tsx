...
const Hero = () => {
  return (
    <div className="mt-10 md:mt-14 flex flex-col items-start justify-center font-gilmed text-white">
      <h1 className="font-gilbold text-2xl md:text-[2.5rem] lg:text-[5.5rem] w-1/2 leading-[3rem] lg:leading-[6rem] uppercase">Spider-Man: 
No Way Home</h1>
      ...
      <div className="mt-7">
        <Button title="Watch Now" icon="ci:play-circle-outline" padding='p-2.5 md:p-4 lg:p-6' />
      </div>
    </div>
  );
};
